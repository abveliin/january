...
function Parteners({ parteners }: I_parteners) {
  return (
    <div>
      ...
      <div className="flex flex-wrap justify-center items-center w-full py-6 px-6">
        {parteners.map((partener) => (
          ...
          >
            <Image
              ...
              height={500}
              //placeholder="blur"
              className="object-cover object-center w-auto h-16 md:h-32 rounded-lg shadow-2xl overflow-hidden"
            />
          </div>
        ))}
      </div>
